...
namespace Prototype_Pattern
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Order changes:");
            ((FoodOrder)manager["2/3/2020"]).customerName = "Jeff";
            ((FoodOrder)manager["2/3/2020"]).info.id = 5555;
            Console.WriteLine("Order changes:");
            ((FoodOrder)manager["2/3/2020"]).Debug();
            Console.WriteLine("cloned Order changes:");
            managerOrder.Debug();
